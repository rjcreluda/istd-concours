...
@section('content')
    ...
    <!-- /.row -->
    @php
        $doc_title = 'Salle '.$salle->reference
    @endphp
    <!-- .row -->
    <div class="row">
        <div class="col-md-12">
            <div class="white-box">
                <div class="box-title d-flex flex-wrap">
                    <h4 class="pr-3">Voir autre salles</h4>
                    <select name="salle_id" id="salles">
                        ...
                        selected
                        @endif
                        >{{ $p->reference }} - {{ $p->localisation }}</option>
                        @endforeach
                    </select>
                </div>
...
@section('footerScript')
    ...
    <script>
        ...
        $('#salles').change( function() {
            ...
            let url = current_url.substring(0, current_url.lastIndexOf('/')) + '/' + salle_id;
